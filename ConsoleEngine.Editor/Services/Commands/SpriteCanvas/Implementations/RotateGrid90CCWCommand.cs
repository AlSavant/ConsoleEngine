...
{
    internal sealed class RotateGrid90CCWCommand : LogicCommand, IRotateGrid90CCWCommand
    {
        private readonly ICanvasDrawingService canvasDrawingService;

        public RotateGrid90CCWCommand(ICanvasDrawingService canvasDrawingService)
        {
        ...
        {
            canvasDrawingService.Rotate90CCW();
        }
    }
}
